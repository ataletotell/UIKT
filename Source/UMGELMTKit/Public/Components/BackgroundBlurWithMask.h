...
#include "Components/BackgroundBlurWithMaskDefine.h"
...
class UMGELMTKIT_API UBackgroundBlurWithMask : public UContentWidget, public FTickableGameObject
{
...
public:
	...
	/** Smoothly lerp blur strength toward InTargetStrength at InRate units/second. */
	UFUNCTION(BlueprintCallable, Category = "Appearance")
		void SetBlurStrengthSmooth(float InTargetStrength, float InRate = 20.f);
...
private:
	float BlurStrengthTarget   = 0.f;
	float BlurTransitionRate   = 0.f;
	bool  bBlurTransitionActive = false;
};
